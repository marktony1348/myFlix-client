...
export class ProfileView extends React.Component {
    ...
    getUser = (token) => {
        ...
        axios.get('https://marcotony-13489.herokuapp.com/users/${Username}', {
    ...
    editUser = (e) => {
        ...
        axios
            .put(
                'https://marcotony-13489.herokuapp.com/users/${Username}',
                {
    ...
    onRemoveFavorite = (e, movie) => {
        ...
        axios.delete('https://marcotony-13489.herokuapp.com/users/${Username}/movies/${movie._id}',
                {
                    headers: { Authorization: `Bearer ${token}` },
                }
            )
    ...
    onDeleteUser() {
        ...
        axios
            .delete('https://marcotony-13489.herokuapp.com/user/${Username}', {
                headers: { Authorization: `Bearer ${token}` },
            })
            .then((response) => {
                console.log(response);
